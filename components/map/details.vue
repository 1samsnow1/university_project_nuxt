<template>
    <article class="pt-2 pb-8 px-3 lg:px-0 bg-white flex flex-col items-center rounded-md shadow-sm shadow-gray-300">
        <figure class="w-fit border border-blue-300 bg-gray-100 rounded-md">
